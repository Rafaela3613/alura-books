...
<br>
  ...
  <div align="center">
    <a target="_blank" href="https://alura-books-beta-blond.vercel.app/">
    <img width="90%" src="assets/projeto-figma.png" alt="alura-books">
    </a>
  </div>
...
<br>
🧑‍🚀 A idéia deste projeto foi disponibilizada no curso de formação Front End "A partir do zero: Html, Css para projetos web", contendo 6 módulos e um total de 53 horas apresentado por Guilherme Lima, Rafaella Ballerini e Monica Hillman ❤️‍🔥.
...
<br>Para visualizar a versão atual do projeto é só<a href="https://alura-books-beta-blond.vercel.app/"> "Clicar aqui".</a>🚀
